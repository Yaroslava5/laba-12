def p1():
    class Restaurant:
        ...
        def describe_restaurant(self):
            print(f"{self.name} это {self.cuisine_type} ресторан.")
...
def p2():
    class IceCreamStand:
        ...
        def check_flavor(self, flavor):
            if flavor in self.flavors:
                ...
                print(f'Сорта {flavor} не найден в списке')
    ...
    my_stand = IceCreamStand("Кафе-мороженное", ['ванильное', 'шоколадное', 'клубничное'], 'Московский проспект','10.00 - 17.00', ['эскимо', 'стакан'])
...
def p3():
    ...
    my_stand = IceCreamStand("Мир вкусов", ["ванильное", "шоколадное", "клубничное", "фисташковое"])

    root = tk.Tk()
    root.title("Мир вкусов")
